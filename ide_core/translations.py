...
TRANSLATIONS = {
    'ru': {
        ...
        'template_tip': 'Совет: Скопируй шаблон выше и вставь его в основной редактор (вкладка слева). Потом можешь менять код как хочешь!',
    },
    'en': {
        ...
        'template_tip': 'Tip: Copy the template above and paste it into the main editor (left tab). Then you can modify it as you like!',
    },
}