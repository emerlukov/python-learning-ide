...
class PythonLearningApp(MDApp):
    ...
    def _safe_wrap_buttons(self):
        ...
        try:
            ...
            if hasattr(self, 'root_layout'):
                ...
                print(f"[Vibration] Successfully wrapped {count} buttons")
        except Exception as e:
            print(f"[Vibration] Wrap failed: {e}")
    ...
    def _request_android_permissions(self):
        ...
        try:
            ...
            print(f"[ERROR] Failed to request permissions: {e}")
    ...
    def show_result_popup(self, result):
        ...
        # ========== ДОБАВИТЬ ОБЁРТКУ КНОПОК В ПОПАПЕ РЕЗУЛЬТАТА ==========
