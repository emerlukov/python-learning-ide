...
class PythonLearningApp(MDApp):
    ...
    def show_result_popup(self, result):
        ...
        output_view = TextInput(
            ...
            font_name='SourceBold', background_color=theme['result_bg'],
    ...
    def show_api_key_settings(self, instance=None):
        """Показывает настройки API ключа"""
        tr = self.tr
        ...
        status_label = Label(
            ...
            font_name='SourceBold', color=theme['text_color'], font_size=dp(10),
            size_hint_y=None, height=dp(15)
        )
        content.add_widget(status_label)

        key_input = TextInput(
            text=current_key, font_name='SourceBold', hint_text=tr.get('api_key_hint', 'Paste API key'),
            multiline=False, font_size=dp(10), background_color=theme['input_bg'],
            foreground_color=theme['input_text'], hint_text_color=theme['hint_text'],
            size_hint_y=None, height=dp(27), padding=(dp(5), dp(5))
        )
        content.add_widget(key_input)

        info_label = Label(
            text=tr.get('api_info', 'Get key: aistudio.google.com'),
            font_name='SourceBold', color=theme['stats_text'], font_size=dp(8),
        ...
        popup = Popup(
            title=tr.get('api_title', 'API Key'), title_color=theme['popup_title'],
            background='', background_color=theme.get('popup_bg', (1.0, 1.0, 1.0, 1)),
            content=content, size_hint=(0.9, 0.5), auto_dismiss=True
        )

        btn_clear = Button(
            text=tr.get('delete', 'Delete'), font_name='SourceBold',
            background_color=(0.3, 0.1, 0.1, 1), background_normal='', background_down='',
            color=theme['text_color'], font_size=dp(9),
            on_release=lambda x: self._clear_api_key(key_input, status_label)
        )

        btn_save = Button(
            text=tr.get('save', 'Save'), font_name='SourceBold',
            background_color=theme['widget_bg'], background_normal='', background_down='',
            color=theme['text_color'], font_size=dp(9),
    ...
    def _get_example_titles(self):
        """Возвращает список названий примеров"""
    ...
    def load_example(self, spinner, text):
        ...
        example_map = {
            '1. Hello World': '1. Hello World', '2. Variables': '2. Переменные',
            '2. Переменные': '2. Переменные', '3. Input': '3. Ввод данных',
            '3. Ввод': '3. Ввод данных', '4. Conditions': '4. Условия',
            '4. Условия': '4. Условия', '5. For Loop': '5. Цикл For',
            '5. Цикл For': '5. Цикл For', '6. While Loop': '6. Цикл While',
            '6. Цикл While': '6. Цикл While', '7. Lists': '7. Списки',
            '7. Списки': '7. Списки', '8. List Comprehensions': '8. Генераторы списков',
            '8. Генераторы списков': '8. Генераторы списков', '9. Dictionaries': '9. Словари',
            '9. Словари': '9. Словари', '10. Functions': '10. Функции',
            '10. Функции': '10. Функции', '11. Lambda': '11. Lambda',
            '12. Classes': '12. Классы', '12. Классы': '12. Классы',
            '13. Inheritance': '13. Наследование', '13. Наследование': '13. Наследование',
            '14. Errors': '14. Ошибки', '14. Ошибки': '14. Ошибки',
            '15. Files': '15. Файлы', '15. Файлы': '15. Файлы',
            '16. Recursion': '16. Рекурсия', '16. Рекурсия': '16. Рекурсия',
    ...
    def _build_examples(self):
        """Возвращает словарь с примерами кода"""
