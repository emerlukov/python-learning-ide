...
class TestExamplesManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Патчим os.getcwd()
        self.getcwd_patcher = patch('os.getcwd', return_value=self.temp_dir)
        self.getcwd_patcher.start()
    ...
    def test_get_localized_titles_russian(self):
        ...
        # Проверяем первые 3
        self.assertEqual(titles[0], "1. Hello World")
        self.assertEqual(titles[1], "2. Переменные")
        self.assertEqual(titles[2], "3. Ввод данных")
    ...
    def test_get_localized_titles_english(self):
        ...
        self.assertEqual(titles[0], "1. Hello World")
        self.assertEqual(titles[1], "2. Variables")
        self.assertEqual(titles[2], "3. Input")
