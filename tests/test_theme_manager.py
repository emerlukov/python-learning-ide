...
class TestThemeManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from core.themes import ThemeManager, DARK_THEME, LIGHT_THEME
    ...
    def test_apply_saved_theme(self):
        ...
        with patch('core.settings.SettingsManager.get_theme', return_value='light'):
...
class TestSyntaxStyleManager(unittest.TestCase):
    ...
    def setUp(self):
        """Подготовка перед каждым тестом"""
        from core.themes import SyntaxStyleManager
