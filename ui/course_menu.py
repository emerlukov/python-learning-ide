...
class CourseMenu(BoxLayout):
    ...
    def _create_ui(self):
        ...
        # Помечаем кнопку, чтобы _wrap_buttons не добавил вибрацию повторно.
        # Вибрация вызывается вручную один раз в _on_continue.
    ...
    def _wrap_buttons(self):
        """Обёртывает все кнопки меню для вибрации"""
