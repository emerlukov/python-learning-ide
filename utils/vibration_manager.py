...
def wrap_all_buttons(widget, recursive=True):
    ...
    Args:
        widget: Корневой виджет
        recursive: Обходить ли дочерние виджеты рекурсивно
    """
    if widget is None:
        return
    ...
    try:
        ...
        button_types = (Button, MDRectangleFlatButton, MDIconButton,
                        MDFlatButton, MDRoundFlatButton)
